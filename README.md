...
Copy or extract the "CostAnalysis" folder and all its contents to your desktop. NOTE: You may add new sub folders, but do not change existing folder names, including the "CostAnalysis.net" root folder, unless you know what you are doing.
